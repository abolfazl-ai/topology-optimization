...
[ pasS, pasV ] = deal( (1:10*nely), [] );                                           % UD, passive solid and void el.
F = sparse( 2, 1, -1, nDof, 1 );                                 % define load vector
...
while ch > 1e-4 && loop < maxit
  ...
  dV0 = imfilter( reshape( dV, nely, nelx ) ./ dHs, h, 'symmetric', 'corr' );              % filter compliance sensitivity
