...
ps = [3, 4, 5, 6, 7]
rs = [np.sqrt(3), 2.00, 2.25, 2.50, 2.75, 2 * np.sqrt(3), 3.50, 4.00, 4.50, 5.00]
vfs = [0.200, 0.225, 0.250, 0.275, 0.300, 0.325, 0.350, 0.375, 0.400, 0.425, 0.450, 0.475, 0.500, 0.550, 0.600]
